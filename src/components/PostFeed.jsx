    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="mb-6">
            ...
            className="bg-blue-600 text-white rounded-md text-lg 
                        hover:bg-yellow-400 hover:text-white 
                        border border-blue-600 transition-all duration-200 transform hover:scale-105 inline-block"
            >
            Create New Post
            </Link>
        </div>
      ...
      {posts.length === 0 ? (
        ...
        <div className="space-y-6">
            {posts.map(post => (
            <div key={post.id} className="bg-white rounded-lg shadow-md p-8"> {/* increased padding */}
                <div className="flex jus    tify-between items-start mb-4">
